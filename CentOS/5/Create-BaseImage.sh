...
mirrorurl="http://ftp.jaist.ac.jp/pub/Linux/CentOS/5.10/os/x86_64/CentOS/"
...
sudo wget https://raw.github.com/dotcloud/docker/master/contrib/init/sysvinit-debian/docker -O /etc/init.d/docker
